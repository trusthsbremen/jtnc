...
import de.hsbremen.tc.tnc.im.container.Im;
import de.hsbremen.tc.tnc.im.container.ImContainer;

public class ReceiveMessageFunctionCallAdapter implements FunctionCall{
	
    private final ImContainer imContainer;
    private final ImConnection imConnection;
    private final PbMessageValueIm message;

    
    public ReceiveMessageFunctionCallAdapter(final ImContainer im, final ImConnection imConnection, PbMessageValueIm message){
        this.imContainer = im;
