...
public class DefaultImcHandler2 implements ImHandler{

	private static final Logger LOGGER = LoggerFactory.getLogger(DefaultImcHandler2.class);
	...
	public DefaultImcHandler2(ImAdapterManager<ImcAdapter> manager, 
