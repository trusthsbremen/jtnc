...
class DefaultClientClientWorkingState extends AbstractState implements ClientWorking {

	private StateHelper<TnccContentHandler> factory;
	
	DefaultClientClientWorkingState(StateHelper<TnccContentHandler> factory){
