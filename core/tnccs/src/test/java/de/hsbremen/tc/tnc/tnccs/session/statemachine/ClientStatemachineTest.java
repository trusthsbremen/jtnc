...
public class ClientStatemachineTest {
	...
	public void setUp(){
		...
		this.machine = new DefaultClientStateMachine(new DefaultClientStateHelper(attributes, handler));
	}
	...
	public void testHandshakeRetryNotAllowed() throws TncException{
		...
		try {
			...
			try {
				this.machine.retryHandshake(HandshakeRetryReasonEnum.TNC_RETRY_REASON_IMC_PERIODIC);
