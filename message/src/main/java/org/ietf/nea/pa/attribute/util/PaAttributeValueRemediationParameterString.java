...
public class PaAttributeValueRemediationParameterString extends AbstractPaAttributeValueRemediationParameter{
...
//    protected final long rpType = PbMessageRemediationParameterTypeEnum.IETF_URI.type();         // 32 bit(s)
    ...
    PaAttributeValueRemediationParameterString(final long length,final String remediationString, final String langCode){
    	super(length);
