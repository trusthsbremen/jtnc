...
public class PbMessageImValueReader implements TnccsReader<PbMessageValueIm>{

	private PbMessageValueImBuilder builder;
	
	public PbMessageImValueReader(PbMessageValueImBuilder builder){
		this.builder = builder;
	}
	
	@Override
	public PbMessageValueIm read(InputStream in, long messageLength)
