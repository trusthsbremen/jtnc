...
public class PbMessageReasonStringValueReader implements TnccsReader<PbMessageValueReasonString>{

	private PbMessageValueReasonStringBuilder builder;
	
	public PbMessageReasonStringValueReader(PbMessageValueReasonStringBuilder builder){
		this.builder = builder;
	}
	
	@Override
	public PbMessageValueReasonString read(InputStream in, long messageLength)
