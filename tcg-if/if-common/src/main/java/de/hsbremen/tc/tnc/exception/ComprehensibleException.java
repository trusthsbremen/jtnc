...
public abstract class ComprehensibleException extends Exception {
	 ...
	 * @param arg0
	 */
	protected ComprehensibleException(final String arg0, final String...reasons) {
		super(arg0);
	 ...
	 * @param arg1
	 */
	protected ComprehensibleException(final String arg0, final Throwable arg1, final String...reasons) {
		super(arg0, arg1);
		this.reasonArguments = reasons;
	}
