...
public class PbMessageReasonStringSerializationHandler implements TnccsSerializationHandler<PbMessageValueReasonString> {

	private static final int MESSAGE_VALUE_FIXED_SIZE = PbMessageValueReasonString.FIXED_LENGTH;
	
	private static final class Singleton{
		static final PbMessageReasonStringSerializationHandler INSTANCE = new  PbMessageReasonStringSerializationHandler();  
	}
	
	public static  PbMessageReasonStringSerializationHandler getInstance(){
	    	return Singleton.INSTANCE;
	}
	    
	private  PbMessageReasonStringSerializationHandler(){
	    	// Singleton
	}
	...
	public PbMessageValueReasonString decode(final InputStream in, final long length) throws SerializationException {
		...
		value = new PbMessageValueReasonString(reasonString, langCode);
