...
public class PbMessageLanguagePreferenceSerializationHandler implements TnccsSerializationHandler<PbMessageValueLanguagePreference> {

	private static final int MESSAGE_VALUE_FIXED_SIZE = 0;
	
	private static final class Singleton{
		private static final PbMessageLanguagePreferenceSerializationHandler INSTANCE = new PbMessageLanguagePreferenceSerializationHandler();  
	}
	public static  PbMessageLanguagePreferenceSerializationHandler getInstance(){
	    	return Singleton.INSTANCE;
	}
	    
	private  PbMessageLanguagePreferenceSerializationHandler(){
	    	// Singleton
	}
	...
	public PbMessageValueLanguagePreference decode(final InputStream in, final long length) throws SerializationException {
		...
		value = new PbMessageValueLanguagePreference(preferedLanguage);
