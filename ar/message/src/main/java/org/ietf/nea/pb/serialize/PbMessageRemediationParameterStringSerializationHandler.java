...
class PbMessageRemediationParameterStringSerializationHandler implements TnccsSerializationHandler<PbMessageValueRemediationParameterString> {

	private static final int MESSAGE_VALUE_FIXED_SIZE = PbMessageValueRemediationParameterString.FIXED_LENGTH;
	
	private static final class Singleton{
		static final PbMessageRemediationParameterStringSerializationHandler INSTANCE = new  PbMessageRemediationParameterStringSerializationHandler();  
	}
	
	static  PbMessageRemediationParameterStringSerializationHandler getInstance(){
	    	return Singleton.INSTANCE;
	}
	    
	private  PbMessageRemediationParameterStringSerializationHandler(){
	    	// Singleton
	}
